    ...
    <main>
        <div class="c-mv">
            ...
            <div class="c-mv__content">
                <h1 class="c-mv__ttl">Việt Nam - Trung Quốc, Hồng Kông và Đài Loan.</h1>
                <nav class="c-breadcrumb">
                    <ul class="c-breadcrumb__list">
                        <li class="c-breadcrumb__item"><a href="<?= url_home ?>" class="c-breadcrumb__link">Trang Chủ</a></li>
                        <li class="c-breadcrumb__item"><span class="c-breadcrumb__txt">Việt Nam - Trung Quốc, Hồng Kông và Đài Loan.</span></li>
                    </ul>
                </nav>
            </div>
        </div>
        ...
        <div class="c-content">
            <div class="container">
                <div class="ttime-content">
                    <h2 class="c-content__ttl">Việt Nam - Trung Quốc, Hồng Kông và Đài Loan.</h2>
                    <div class="cstep">
