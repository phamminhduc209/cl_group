<header class="l-header">
	<div class="l-header__wrap">
		...
		<nav class="l-header__nav">
			<ul class="gl-nav">
				<li class="gl-nav__item hasChild">
					<a href="<?= url_home ?>en/about/" class="gl-nav__link">About CL Group</a>
					<!-- <div class="gl-nav__child">
						<ul class="gl-nav__child-wrap">
							<li><a href="<?= url_home ?>en/ve-chung-toi/tong-quan/" class="gl-nav__child-link">Tổng quan</a></li>
							<li><a href="<?= url_home ?>en/ve-chung-toi/tam-nhin-su-menh/" class="gl-nav__child-link">Tầm nhìn - Sứ mệnh</a></li>
							<li><a href="<?= url_home ?>en/ve-chung-toi/gia-tri-cot-loi/" class="gl-nav__child-link">Giá trị cốt lõi</a></li>
						</ul>
					</div>
		...
		<div class="l-header__lang">
			<a href="<?= url_home ?>">VI</a>
			<span>/</span>
			<a href="<?= url_home ?>en/" class="on">EN</a>
		</div>
