<footer>
	<div class="wrap">
		<div class="ft-grid">
			<div>
				<div class="ft-brand"><img src="<?= url_path ?>assets/images/logo.png" alt=""></div>
				<p class="ft-info">Kết nối hành trình - Tối ưu chuỗi cung ứng</p>
				<ul class="ft-sc">
					<li><a href="#"><img src="<?= url_path ?>assets/images/icon_facebook.png" alt=""></a></li>
					<li><a href="#"><img src="<?= url_path ?>assets/images/icon_linkedin.png" alt=""></a></li>
				</ul>
			</div>
			<div class="ft-col">
				<h4>Liên hệ</h4>
				<ul>
					<li><p>CÔNG TY TNHH THƯƠNG MẠI DỊCH VỤ CL GROUP</p></li>
					<li><p>Mã số thuế: 0317909228</p></li>
